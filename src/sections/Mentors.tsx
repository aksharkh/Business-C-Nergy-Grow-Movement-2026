            ...
            <Reveal key={i} delay={i * 50} direction="left">
              ...
              >
                ...
                <img
                  src={mentor.photo}
                  alt={mentor.name}
                  className={`hidden md:block absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-56 h-56 object-cover rounded-xl z-0 pointer-events-none transition-all duration-500 ease-out border-2 border-[#6B2D8C] shadow-2xl shadow-purple-500/40 ${
