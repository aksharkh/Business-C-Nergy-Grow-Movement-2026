const Marquee = () => {
  return (
    <div className="border-y border-white/40 py-6 overflow-hidden bg-[#6B2D8C]/5 backdrop-blur-md relative z-20 shadow-sm">
      <div className="flex animate-[marquee_40s_linear_infinite] w-max gap-12 items-center hover:[animation-play-state:paused] cursor-default">
        {[...Array(8)].map((_, i) => (
          <div key={i} className="flex items-center gap-12">
            <span className="text-2xl font-serif text-slate-600 hover:text-[#6B2D8C] transition-colors duration-300">
