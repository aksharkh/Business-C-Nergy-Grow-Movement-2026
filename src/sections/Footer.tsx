const Footer = () => {
  return (
    <footer className="py-20 border-t border-white/10 bg-[#1b052a] text-slate-500 text-sm relative z-10">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-4">
          <div className="w-8 h-8 bg-[#6B2D8C] text-white flex items-center justify-center font-serif rounded-lg shadow-lg">
            C
          </div>
